...
Distributed under a **Proprietary License**. All rights reserved. Unauthorized use, copying, modification, or distribution is strictly prohibited. Individuals and entities are not permitted to use this code for any purpose without explicit written consent.
